                ...
                <Table>
                  ...
                  <TableBody>
                    {items.map((item: /* // */ any, idx) => {
                      ...
                      return (
                      <TableRow key={item.id} className={isRemoved ? 'bg-danger-soft line-through opacity-60' : pmStatus === 'approved' ? 'bg-success-soft/30' : pmStatus === 'adjusted' ? 'bg-warning-soft/30' : ''}>
