                      ...
                      {w.withdrawal_type === 'operations' || w.purpose === 'company_operations'
                        ...
                        <TableCell>
                          {w.withdrawal_type === 'director_payout' ? (
                            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-warning-soft text-warning-soft-foreground border border-warning/40">
                              Director Payout
                            </span>
                          ) : (
