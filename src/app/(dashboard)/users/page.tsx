                  ...
                  <TableRow key={u.id}>
                    ...
                    <TableCell>
                      <Badge variant="secondary" className={
                        ...
                        u.role === 'project_manager' ? 'bg-info-soft text-info-soft-foreground' :
                    ...
                    <TableCell>
                      <Badge variant="secondary" className={u.is_active ? 'bg-success-soft text-success-soft-foreground' : 'bg-muted text-muted-foreground'}>
                        {u.is_active && <span className="mr-1 inline-block w-1.5 h-1.5 rounded-full bg-success-soft0 animate-pulse" />}
