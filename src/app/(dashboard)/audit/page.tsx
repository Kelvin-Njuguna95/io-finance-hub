            ...
            <div className="mt-4 space-y-4">
              ...
              {selectedLog.old_values && Object.keys(selectedLog.old_values).length > 0 && (
                <div>
                  ...
                  <pre className="text-xs bg-danger-soft rounded-md p-3 overflow-x-auto whitespace-pre-wrap">
              ...
              {selectedLog.new_values && Object.keys(selectedLog.new_values).length > 0 && (
                <div>
                  ...
                  <pre className="text-xs bg-success-soft rounded-md p-3 overflow-x-auto whitespace-pre-wrap">
