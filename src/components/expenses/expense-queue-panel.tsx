    ...
    >
        ...
        <div>
          ...
          <div className="h-2 w-full rounded-full bg-muted overflow-hidden">
            <div className="h-full rounded-full bg-success-soft0 transition-all" style={{ width: `${progressPct}%` }} />
          </div>
        </div>

        {/* Summary stats */}
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-md bg-warning-soft p-2.5 text-center">
          ...
          <div className="rounded-md bg-success-soft p-2.5 text-center">
        ...
        {compact && (voided.length > 0 || underReview.length > 0 || modified.length > 0) && (
          <div className="flex gap-2 flex-wrap">
            ...
            {underReview.length > 0 && (
              <Badge className="bg-info-soft text-info-soft-foreground border-0">{underReview.length} Under Review</Badge>
            )}
            {voided.length > 0 && (
