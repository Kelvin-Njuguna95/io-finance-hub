...
export function statusTone(status: 'On Track' | 'Watch' | 'Action Needed') {
  if (status === 'On Track') return 'bg-success-soft text-success-soft-foreground border-success/40';
  if (status === 'Watch') return 'bg-warning-soft text-warning-soft-foreground border-warning/30';
  return 'bg-danger-soft text-danger-soft-foreground border-danger/40';
}
